...
<!-- Mirrored from coderthemes.com/ubold/layouts/dark/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 May 2019 04:46:52 GMT -->
<head>
        <meta charset="utf-8" />
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="navbar-custom">
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="{{asset('assets/images/users/admin.jpg')}}" alt="d" class="rounded-circle">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                            ...
                            <!-- item-->
                            <a href="index.blade.php" class="dropdown-item notify-item">
                ...
                <!-- LOGO -->
                <div class="logo-box">
                    <a href="home.blade.php" class="logo text-center">
                        <span class="logo-lg">
                            <img src="{{asset('assets/images/habibsoft.png')}}" alt="ha" height="60">
                            <!-- <span class="logo-lg-text-light">UBold</span> -->
                        </span>
                        <span class="logo-sm">
                            <!-- <span class="logo-sm-text-dark">U</span> -->
                            <img src="{{asset('assets/images/logo-sm1.png')}}" alt="" height="40">
                        </span>
                    </a>
                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <h5 class="mt-0">Web Applications</h5>
                                            <ul class="list-unstyled megamenu-list">
                                                <li>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <h3 class="mt-1"><span data-plugin="counterup">78.41</span>k</h3>
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="card-box">
                                    ...
                                    <div class="widget-chart text-center" dir="auto">
                                        <input data-plugin="knob" data-width="160" data-height="160" data-linecap=round data-bgColor="#525e6b" data-fgColor="#f1556c" value="60" data-skin="tron" data-angleOffset="180" data-readOnly=true data-thickness=".12"/>
                                        ...
                                        <table class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="javascript: void(0);" class="btn btn-xs btn-secondary"><i class="mdi mdi-plus"></i></a>
...
<!-- Mirrored from coderthemes.com/ubold/layouts/dark/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 May 2019 04:47:24 GMT -->
</html>