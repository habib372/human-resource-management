                        ...
                        <div class="col-12">
                            ...
                            <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">Monthly Attendance</a></li>
                                </div>
                        ...
                        <div class="row my-2">
                            <div class="col-12 ">
                                ...
                                <div class="card-header">
                                    <h4 class="card-title  float-left">Monthly Attendance Table</h4> 
                                ...
                                <div class="card-box mb-0"> 
                                    <div class="table-responsive">
                                            <table id="demo-foo-filtering" class="table table-bordered text-center mb-3" data-page-size="5">                                 
                                                <thead>
                                                    <tr>
                                                        <th >SN</th>
                                                        <th >Emp-ID</th>
